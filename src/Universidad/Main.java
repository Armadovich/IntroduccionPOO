...
public class Main {
    public static void main(String[] args) {
        ...
        test[4] = new Docente("Paco",100,"12312412G",'O',87,1.89,"Tus muertos");
        test[5] = new Alumno("Ataulfo", 18,"74878641535F",'G',75,1.85,"me la pela","me la pela aun mas");
        test[6] = new AlumnoInternacional("Ak47", 23,"5456454F",'H',98,1.95,"me la pela","me la pela aun mas", "Mauritania");
